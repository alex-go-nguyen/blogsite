    ...
    >
      ...
      <div className="grid grid-rows-4 mt-4">
        ...
        {isLoading ? (
          ...
          author && (
            <Link href={`/writer/${author.id}`} className="flex items-center font-sm text-color-blur row-span-1">
              <Avatar src={author.image} width={40} height={40} alt={author.name} />
              <p className="ml-2 mr-4 font-medium">{author.name}</p>
